...
`macro_frais.terme.sa` ← structure réelle du JSON téléphone
`macro_frais.biometries.terme_sa` ← format alternatif
`case.terme_issue` ← formulaire admin (parse "24 SA + 3j" → 24)
`body.terme_sa` ← override manuel API
